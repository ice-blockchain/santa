...
func TestSetup() func() {
	...
	return func() {
		...
		if dbError != nil || mbError != nil {
			err := errors.New("achievements fixture cleanup failed")
...
func setupDBAndMessageBroker() (func(), func()) {
	...
	go func() {
		defer wg.Done()
		cleanUpStorage = storagefixture.TestSetup("achievements")
	}()
	go func() {
		defer wg.Done()
		cleanUpMessageBroker = messagebrokerfixture.TestSetup("achievements")
	}()
	wg.Wait()
